...
export const processJsonUpload = async (upload: Promise<FileUpload | Upload>): Promise<any> => {
  try {
...
// export const processJsonUpload = async (upload: Promise<FileUpload | Upload>): Promise<{ filePath: string, jsonContent: any }> => {
//   try {
